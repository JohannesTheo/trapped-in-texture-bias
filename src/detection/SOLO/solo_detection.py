...
if __name__ == '__main__':
    ...
    CUDA = 'CUDA_VISIBLE_DEVICES="0,1,3"'
    ...
    for model, cfg, weights in MODELS:
        ...
        os.system(f"{CUDA} python tools/train_net.py --config-file {cfg} --eval-only --num-gpus 3 MODEL.WEIGHTS ./{weights} OUTPUT_DIR training_dir/{model}")
