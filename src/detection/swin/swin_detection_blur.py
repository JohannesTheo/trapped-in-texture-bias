...
if __name__ == '__main__':
    ...
    for model, cfg, release_version, weights in MODELS:
        ...
        os.system(f"CUDA_VISIBLE_DEVICES=1 python tools/test.py configs/swin/{cfg} {weights} --format-only --eval-options jsonfile_prefix=results")
        ...
        for dataset in [STYLIZED_COCO_PATH]:

                    
            # create symlink to the stylized images
            os.symlink(DATA_ROOT / dataset / 'val2017' , COCO_PATH / 'val2017')
