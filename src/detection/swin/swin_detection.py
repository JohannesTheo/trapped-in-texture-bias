...
if __name__ == '__main__':
    ...
    MODELS = [
        ["mask_rcnn_swin-T_1x",         "mask_rcnn_swin_tiny_patch4_window7_mstrain_480-800_adamw_1x_coco.py",  "v1.0.3/", "mask_rcnn_swin_tiny_patch4_window7_1x.pth"],
        ...
        ["cascade_mask_rcnn_swin-T_1x", "cascade_mask_rcnn_swin_tiny_patch4_window7_mstrain_480-800_giou_4conv1f_adamw_1x_coco.py",  "v1.0.3/", "cascade_mask_rcnn_swin_tiny_patch4_window7_1x.pth"],
        ["cascade_mask_rcnn_swin-T_3x", "cascade_mask_rcnn_swin_tiny_patch4_window7_mstrain_480-800_giou_4conv1f_adamw_3x_coco.py",  "v1.0.2/", "cascade_mask_rcnn_swin_tiny_patch4_window7.pth"],
        ["cascade_mask_rcnn_swin-S_3x", "cascade_mask_rcnn_swin_small_patch4_window7_mstrain_480-800_giou_4conv1f_adamw_3x_coco.py", "v1.0.2/", "cascade_mask_rcnn_swin_small_patch4_window7.pth"],
    ...
    for model, cfg, release_version, weights in MODELS:
        ...
        os.system(f"python tools/test.py configs/swin/{cfg} {weights} --format-only --eval-options jsonfile_prefix=results")
